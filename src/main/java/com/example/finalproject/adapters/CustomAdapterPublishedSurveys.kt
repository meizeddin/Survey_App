...
class CustomAdapterPublishedSurveys(appContext: Context, private val surveyList: ArrayList<Survey>) : BaseAdapter(){
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if(convertView == null) {
            view = inflater.inflate(R.layout.activity_published_surveys_listview_s, parent, false)
    ...
    class ViewHolder(view: View) {
        val mSurvey: TextView = view.findViewById(R.id.textViewSurvey)
    }
}